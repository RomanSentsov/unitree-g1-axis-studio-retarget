...
from hands_retargeting.kinematics_adaptor import MimicJointKinematicAdaptor
from hands_retargeting.optimizer_utils import LPFilter
from hands_retargeting.robot_wrapper import RobotWrapper
from hands_retargeting.seq_retarget import SeqRetargeting
...
class RetargetingConfig:
    ...
    def build(self) -> SeqRetargeting:
        from hands_retargeting.optimizer import (
            VectorOptimizer,
            PositionOptimizer,
            DexPilotOptimizer,
        )
